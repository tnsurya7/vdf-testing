...
/** Simulate email notification — no-op in UI (real emails sent by backend) */
export function simulateEmail(_recipients: string[], _subject: string, _body: string): void {
  // intentionally silent — backend handles real email sending
}
